...
public class Settlement {
    ...
    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "amountUnits",
                    column = @Column(name="gross_amount_units",nullable = false)),
            @AttributeOverride(name="currency",
                    column = @Column(name = "gross_currency",nullable = false))
    })
    ...
    @AttributeOverrides({
            ...
            @AttributeOverride(name="currency",
                    column = @Column(name = "refund_currency",nullable = false))
    })
    ...
    @AttributeOverrides({
            ...
            @AttributeOverride(name="currency",
                    column = @Column(name = "gst_currency",nullable = false))
    })
    ...
    @AttributeOverrides({
            ...
            @AttributeOverride(name="currency",
                    column = @Column(name = "fee_currency",nullable = false))
    })
    ...
    @AttributeOverrides({
            ...
            @AttributeOverride(name="currency",
                    column = @Column(name = "net_currency",nullable = false))
    })
